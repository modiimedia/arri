...
private typealias __ExampleClientHeadersFn = (() -> MutableMap<String, String>?)?

class ExampleClient(
    private val httpClient: HttpClient,
    private val baseUrl: String,
    private val headers: __ExampleClientHeadersFn,
...
private suspend fun __handleSseRequest(
    ...
    method: HttpMethod,
    params: ExampleClientModel?,
    headers: __ExampleClientHeadersFn,
    backoffTime: Long,
    maxBackoffTime: Long,
    lastEventId: String?,
    onOpen: ((response: HttpResponse) -> Unit) = {},
