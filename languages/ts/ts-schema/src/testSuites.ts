...
> = {
    boolean: {
        ...
        badInputs: ['hello world', 100, -100, {}],
    },
    timestamp: {
        schema: a.timestamp(),
        goodInputs: ['2001-01-01T00:00:00.000Z', 1000],
        expectedResults: [new Date('2001-01-01T00:00:00.000Z'), new Date(1000)],
        badInputs: ['hello world', true, false, [], {}],
    },
    int8: {
        schema: a.int8(),
        goodInputs: [1, '1', '15', 15, '-15', -15],
        expectedResults: [1, 1, 15, 15, -15, -15],
        badInputs: ['hello world', 1.1, '1.1', 1000, '1000'],
    },
    uint8: {
        schema: a.uint8(),
        goodInputs: [1, '1', '15', 15],
        expectedResults: [1, 1, 15, 15],
        badInputs: [
            'hello world',
            1.1,
            '1.1',
    ...
    int64: {
        schema: a.int64(),
        goodInputs: ['1', 1, '-1', -1],
        expectedResults: [BigInt(1), BigInt(1), BigInt(-1), BigInt(-1)],
        badInputs: [
            'hello world',
    ...
    uint64: {
        schema: a.uint64(),
        goodInputs: ['1', 1],
        expectedResults: [BigInt(1), BigInt(1)],
        badInputs: [
            'hello world',
        ...
        goodInputs: [
            {
                ...
                int64: '1000',
                uint64: '1000',
                array: ['true', 'TRUE', 'false', 'FALSE', 1, 0, '1', '0'],
            },
        ],
        expectedResults: [
            {
    ...
    'object with nullable fields': {
        ...
        goodInputs: [
            ...
            },
            {
                ...
                int64: null,
                uint64: null,
                array: ['null', null, true, false, 'TRUE', 'FALSE'],
            },
        ],
        expectedResults: [
            {
