...
output.push_str(format!("\"{}\"", &self.hello.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
...
impl ArriModel for AdaptersTypeboxAdapterParams {
    ...
    _ => false,
            ...
            let object = match val {
                Some(serde_json::Value(object_val)) => AdaptersTypeboxAdapterParamsObject.from_json(object_val),
...
let optional_string = match val.get("optionalString") {
                 Some(serde_json::Value(optional_string_val)) => match optional_string_val.get("optionalString") {
    Some(serde_json::Value::String(optional_string_val)) => Some(optional_string_val.to_owned()),
    _ => None,
},
                 _ => None,
            };
...
output.push_str(match &self.enum_field.get("enumField") {
...
output.push_str(match &self.array.get("array") {
...
match &self.optional_string {
                    Some(optional_string_val) => {
                        ...
                        output.push_str(format!("\"{}\"", optional_string_val.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
                    },
                    _ => {},
                };
        output.push('}');
...
parts.push(format!("integer={}", match serde_json::to_string(&self.integer) {
                Ok(integer_val) => integer_val,
                _ => "".to_string(),
            }));
parts.push(format!("number={}", &self.number.to_string()));
parts.push(format!("enumField={}", match serde_json::to_string(&self.enum_field) {
                Ok(enum_field_val) => enum_field_val,
                _ => "".to_string(),
            }));
parts.push(format!("object={}", AdaptersTypeboxAdapterParamsObject.to_query_params_string()));
parts.push(format!("array={}", match serde_json::to_string(&self.array) {
...
output.push_str(format!("\"{}\"", &self.message.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
...
impl ArriModel for DeprecatedRpcParams {
    ...
    Some(serde_json::Value::String(deprecated_field_val)) => deprecated_field_val.to_owned(),
    _ => "".to_string(),
};
                Self {
                    deprecated_field,
...
output.push_str(format!("\"{}\"", &self.deprecated_field.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
...
impl ArriModel for ObjectWithEveryType {
    ...
    _ => "".to_string(),
            ...
            let timestamp = match val.get("timestamp") {
                Some(serde_json::Value::String(timestamp_val)) => match DateTime::<FixedOffset>::parse_from_rfc3339(timestamp_val.as_str()) {
            ...
            let float32 = match val {
                Some(serde_json::Value::Number(float32_val)) => match f32::try_from(float32_val.as_f64().unwrap_or(0.0)) {
            ...
            let int8 = match val {
                Some(serde_json::Value::number(int8_val)) => int8 _val.as_i64().try_into:: <i8>().unwrap_or(0),
                _ => 0
            };
            let uint8 = match val {
            ...
            let object = match val {
                Some(serde_json::Value(object_val)) => ObjectWithEveryTypeObject.from_json(object_val),
            ...
            let nested_object = match val {
                Some(serde_json::Value(nestedObject_val)) => ObjectWithEveryTypeNestedObject.from_json(nestedObject_val),
    ...
    fn to_json_string(&self) -> String {
        let mut output = "{".to_string();
        output.push_str("\"any\":");
output.push_str(match &self.any.get("any") {
...
output.push_str(match &self.uint8.get("uint8") {
...
output.push_str(match &self.int16.get("int16") {
...
output.push_str(match &self.uint16.get("uint16") {
...
output.push_str(match &self.int32.get("int32") {
...
output.push_str(match &self.uint32.get("uint32") {
...
output.push_str(match &self.int64.get("int64") {
...
output.push_str(match &self.uint64.get("uint64") {
...
output.push_str(match &self.enumerator.get("enumerator") {
...
output.push_str(match &self.record.get("record") {
...
output.push_str(match &self.discriminator.get("discriminator") {
...
output.push_str(nestedObject.to_json_string().as_str());
output.push_str(",\"nestedArray\":");
output.push_str(match &self.nested_array.get("nestedArray") {
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("any={}", match serde_json::to_string(&self.any) {
                Ok(any_val) => any_val,
                _ => "".to_string(),
            }));
parts.push(format!("boolean={}", &self.boolean));
...
parts.push(format!("uint8={}", match serde_json::to_string(&self.uint8) {
                Ok(uint8_val) => uint8_val,
                _ => "".to_string(),
            }));
parts.push(format!("int16={}", match serde_json::to_string(&self.int16) {
                Ok(int16_val) => int16_val,
                _ => "".to_string(),
            }));
parts.push(format!("uint16={}", match serde_json::to_string(&self.uint16) {
                Ok(uint16_val) => uint16_val,
                _ => "".to_string(),
            }));
parts.push(format!("int32={}", match serde_json::to_string(&self.int32) {
                Ok(int32_val) => int32_val,
                _ => "".to_string(),
            }));
parts.push(format!("uint32={}", match serde_json::to_string(&self.uint32) {
                Ok(uint32_val) => uint32_val,
                _ => "".to_string(),
            }));
parts.push(format!("int64={}", match serde_json::to_string(&self.int64) {
                Ok(int64_val) => int64_val,
                _ => "".to_string(),
            }));
parts.push(format!("uint64={}", match serde_json::to_string(&self.uint64) {
                Ok(uint64_val) => uint64_val,
                _ => "".to_string(),
            }));
parts.push(format!("enumerator={}", match serde_json::to_string(&self.enumerator) {
...
parts.push(format!("object={}", ObjectWithEveryTypeObject.to_query_params_string()));
parts.push(format!("record={}", match serde_json::to_string(&self.record) {
                Ok(record_val) => record_val,
                _ => "".to_string(),
            }));
parts.push(format!("discriminator={}", match serde_json::to_string(&self.discriminator) {
                Ok(discriminator_val) => discriminator_val,
                _ => "".to_string(),
            }));
parts.push(format!("nestedObject={}", ObjectWithEveryTypeNestedObject.to_query_params_string()));
parts.push(format!("nestedArray={}", match serde_json::to_string(&self.nested_array) {
...
impl ArriModel for ObjectWithEveryNullableType {
    ...
    _ => None,
            ...
            let int8 = match val {
                Some(serde_json::Value::number(int8_val)) => Some(int8 _val.as_i64().try_into:: <i8>().unwrap_or(0)),
                _ => None
            };
            let uint8 = match val {
            ...
            let object = match val {
                Some(serde_json::Value(object_val)) => ObjectWithEveryNullableTypeObject.from_json(object_val),
                _ => None(),
            };
            let record = match val {
            ...
            let nested_object = match val {
                Some(serde_json::Value(nestedObject_val)) => ObjectWithEveryNullableTypeNestedObject.from_json(nestedObject_val),
                _ => None(),
            };
            let nested_array = match val {
...
output.push_str(",\"boolean\":");
output.push_str(format!(match &self.boolean {
    Some(boolean_val) => boolean_val.to_string(),
    None => "null".to_string(),
}.as_str());
output.push_str(",\"string\":");
output.push_str(match &self.string {
    Some(string_val) => string_val.replace("\n", "\\n").replace("\"", "\\\""),
    None => "null".to_string()
}.as_str());
output.push_str(",\"timestamp\":");
output.push_str(match &self.timestamp {
                    Some(timestamp_val) => timestamp_val.to_rfc3339()
                }.as_str());
output.push_str(",\"float32\":");
output.push_str(match &self.float32 {
                    Some(float32_val) => float32.to_string(),
                    _ => "null".to_string(),
                }.as_str());
output.push_str(",\"float64\":");
output.push_str(match &self.float64 {
                    Some(float64_val) => float64_val.to_string(),
                    _ => "null".to_string(),
                }.as_str());
output.push_str(",\"int8\":");
output.push_str(match &self.int8 {
...
output.push_str(",\"object\":");
output.push_str(match &self.object {
...
output.push_str(",\"nestedObject\":");
output.push_str(match &self.nested_object {
                    Some(nestedObject_val) => ObjectWithEveryNullableTypeNestedObject.to_json_string(),
                    _ => "null".to_string(),
                }.as_str());
output.push_str(",\"nestedArray\":");
output.push_str(match &self.nested_array.get("nestedArray") {
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("any={}", match &self.any {
                    Some(any_val) => match serde_json::to_string(any_val) {
                        Ok(any_val_result) => any_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("boolean={}", match &self.boolean {
                    Some(boolean_val) => boolean_val,
                    _ => "null".to_string(),
                }));
parts.push(format!("string={}", match &self.string {
                    Some(string_val) => string_val,
                    _ => "null".to_string(),
                }));
parts.push(format!("timestamp={}", match &self.timestamp {
                    Some(timestamp_val) => timestamp_val.to_rfc3339(),
                    _ => "null".to_string(),
                }));
parts.push(format!("float32={}", match &self.float32 {
                    Some(float32_val) => float32.to_string(),
                    _ => "null".to_string(),
                }));
parts.push(format!("float64={}", match &self.float64 {
                    Some(float64_val) => float64_val.to_string(),
                    _ => "null".to_string(),
                }));
parts.push(format!("int8={}", match &self.int8 {
                    Some(int8_val) => int8_val.to_string(),
                    _ => int8_val.to_string(),));
parts.push(format!("uint8={}", match &self.uint8 {
                    Some(uint8_val) => match serde_json::to_string(uint8_val) {
                        Ok(uint8_val_result) => uint8_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("int16={}", match &self.int16 {
                    Some(int16_val) => match serde_json::to_string(int16_val) {
                        Ok(int16_val_result) => int16_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("uint16={}", match &self.uint16 {
                    Some(uint16_val) => match serde_json::to_string(uint16_val) {
                        Ok(uint16_val_result) => uint16_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("int32={}", match &self.int32 {
                    Some(int32_val) => match serde_json::to_string(int32_val) {
                        Ok(int32_val_result) => int32_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("uint32={}", match &self.uint32 {
                    Some(uint32_val) => match serde_json::to_string(uint32_val) {
                        Ok(uint32_val_result) => uint32_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("int64={}", match &self.int64 {
                    Some(int64_val) => match serde_json::to_string(int64_val) {
                        Ok(int64_val_result) => int64_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("uint64={}", match &self.uint64 {
                    Some(uint64_val) => match serde_json::to_string(uint64_val) {
                        Ok(uint64_val_result) => uint64_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("enumerator={}", match &self.enumerator {
                    Some(enumerator_val) => match serde_json::to_string(enumerator_val) {
                        Ok(enumerator_val_result) => enumerator_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("array={}", match &self.array {
                    Some(array_val) => match serde_json::to_string(array_val) {
                        Ok(array_val_result) => array_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("object={}", match &self.object {
                    Some(serde_json::Value(object_val)) => ObjectWithEveryNullableTypeObject.to_query_params_string(),
                    _ => "null".to_string(),
                }));
parts.push(format!("record={}", match &self.record {
                    Some(record_val) => match serde_json::to_string(record_val) {
                        Ok(record_val_result) => record_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("discriminator={}", match &self.discriminator {
                    Some(discriminator_val) => match serde_json::to_string(discriminator_val) {
                        Ok(discriminator_val_result) => discriminator_val_result,
                        _ => "null".to_string(),
                    },
...
parts.push(format!("nestedObject={}", match &self.nested_object {
                    Some(serde_json::Value(nested_object_val)) => ObjectWithEveryNullableTypeNestedObject.to_query_params_string(),
                    _ => "null".to_string(),
                }));
parts.push(format!("nestedArray={}", match &self.nested_array {
                    Some(nested_array_val) => match serde_json::to_string(nested_array_val) {
                        Ok(nested_array_val_result) => nested_array_val_result,
                        _ => "null".to_string(),
                    },
...
let timestamp = match val.get("timestamp") {
                 Some(serde_json::Value(timestamp_val)) => match timestamp_val.get("timestamp") {
                Some(serde_json::Value::String(timestamp_val)) => match DateTime::<FixedOffset>::parse_from_rfc3339(timestamp_val.as_str()) {
                    Ok(timestamp_val_result) => Some(timestamp_val_result),
                    _ => None,
                },
...
let object = match val.get("object") {
                ...
                Some(serde_json::Value(object_val)) => ObjectWithEveryOptionalTypeObject.from_json(object_val),
...
let nested_object = match val.get("nestedObject") {
                ...
                Some(serde_json::Value(nestedObject_val)) => ObjectWithEveryOptionalTypeNestedObject.from_json(nestedObject_val),
    ...
    fn to_json_string(&self) -> String {
        ...
        match &self.any {
                    Some(any_val) => {
                        ...
                        output.push_str("match any_val.get("any") {
                Some(any_val) => match serde_json::to_string(any_val) {
                    Ok(any_val_result) => any_val_result,
                    _ => "".to_string()
                },
...
match &self.string {
                    Some(string_val) => {
                        ...
                        output.push_str("format!("\"{}\"", string_val.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
                        key_count += 1;
                    },
                    _ => {},
                };
...
match &self.float64 {
                    Some(float64_val) => {
                        ...
                        output.push_str("match float64_val {
                    Some(float64_val) => float64_val.to_string(),
                    _ => "null".to_string(),
                }.as_str());
                        key_count += 1;
...
match &self.uint8 {
                    Some(uint8_val) => {
                        ...
                        output.push_str("match uint8_val.get("uint8") {
                Some(uint8_val) => match serde_json::to_string(uint8_val) {
                    Ok(uint8_val_result) => uint8_val_result,
                    _ => "".to_string()
                },
...
match &self.int16 {
                    Some(int16_val) => {
                        ...
                        output.push_str("match int16_val.get("int16") {
                Some(int16_val) => match serde_json::to_string(int16_val) {
                    Ok(int16_val_result) => int16_val_result,
                    _ => "".to_string()
                },
...
match &self.uint16 {
                    Some(uint16_val) => {
                        ...
                        output.push_str("match uint16_val.get("uint16") {
                Some(uint16_val) => match serde_json::to_string(uint16_val) {
                    Ok(uint16_val_result) => uint16_val_result,
                    _ => "".to_string()
                },
...
match &self.int32 {
                    Some(int32_val) => {
                        ...
                        output.push_str("match int32_val.get("int32") {
                Some(int32_val) => match serde_json::to_string(int32_val) {
                    Ok(int32_val_result) => int32_val_result,
                    _ => "".to_string()
                },
...
match &self.uint32 {
                    Some(uint32_val) => {
                        ...
                        output.push_str("match uint32_val.get("uint32") {
                Some(uint32_val) => match serde_json::to_string(uint32_val) {
                    Ok(uint32_val_result) => uint32_val_result,
                    _ => "".to_string()
                },
...
match &self.int64 {
                    Some(int64_val) => {
                        ...
                        output.push_str("match int64_val.get("int64") {
                Some(int64_val) => match serde_json::to_string(int64_val) {
                    Ok(int64_val_result) => int64_val_result,
                    _ => "".to_string()
                },
...
match &self.uint64 {
                    Some(uint64_val) => {
                        ...
                        output.push_str("match uint64_val.get("uint64") {
                Some(uint64_val) => match serde_json::to_string(uint64_val) {
                    Ok(uint64_val_result) => uint64_val_result,
                    _ => "".to_string()
                },
...
match &self.enumerator {
                    Some(enumerator_val) => {
                        ...
                        output.push_str("match enumerator_val.get("enumerator") {
                Some(enumerator_val) => match serde_json::to_string(enumerator_val) {
                    Ok(enumerator_val_result) => enumerator_val_result,
                    _ => "".to_string()
                },
...
match &self.array {
                    Some(array_val) => {
                        ...
                        output.push_str("match array_val.get("array") {
                Some(array_val) => match serde_json::to_string(array_val) {
                    Ok(array_val_result) => array_val_result,
                    _ => "".to_string()
                },
...
match &self.record {
                    Some(record_val) => {
                        ...
                        output.push_str("match record_val.get("record") {
                Some(record_val) => match serde_json::to_string(record_val) {
                    Ok(record_val_result) => record_val_result,
                    _ => "".to_string()
                },
...
match &self.discriminator {
                    Some(discriminator_val) => {
                        ...
                        output.push_str("match discriminator_val.get("discriminator") {
                Some(discriminator_val) => match serde_json::to_string(discriminator_val) {
                    Ok(discriminator_val_result) => discriminator_val_result,
                    _ => "".to_string()
                },
...
match &self.nested_array {
                    Some(nested_array_val) => {
                        ...
                        output.push_str("match nested_array_val.get("nestedArray") {
                Some(nested_array_val) => match serde_json::to_string(nested_array_val) {
                    Ok(nested_array_val_result) => nested_array_val_result,
                    _ => "".to_string()
                },
    ...
    fn to_query_params_string(&self) -> String {
        ...
        match &self.any {
                Some(any_val) => {
                    parts.push(format!("any={}", match serde_json::to_string(any_val) {
                Ok(any_val) => any_val,
                _ => "".to_string(),
            }));
                },
...
match &self.uint8 {
                Some(uint8_val) => {
                    parts.push(format!("uint8={}", match serde_json::to_string(uint8_val) {
                Ok(uint8_val) => uint8_val,
                _ => "".to_string(),
            }));
                },
...
match &self.int16 {
                Some(int16_val) => {
                    parts.push(format!("int16={}", match serde_json::to_string(int16_val) {
                Ok(int16_val) => int16_val,
                _ => "".to_string(),
            }));
                },
...
match &self.uint16 {
                Some(uint16_val) => {
                    parts.push(format!("uint16={}", match serde_json::to_string(uint16_val) {
                Ok(uint16_val) => uint16_val,
                _ => "".to_string(),
            }));
                },
...
match &self.int32 {
                Some(int32_val) => {
                    parts.push(format!("int32={}", match serde_json::to_string(int32_val) {
                Ok(int32_val) => int32_val,
                _ => "".to_string(),
            }));
                },
...
match &self.uint32 {
                Some(uint32_val) => {
                    parts.push(format!("uint32={}", match serde_json::to_string(uint32_val) {
                Ok(uint32_val) => uint32_val,
                _ => "".to_string(),
            }));
                },
...
match &self.int64 {
                Some(int64_val) => {
                    parts.push(format!("int64={}", match serde_json::to_string(int64_val) {
                Ok(int64_val) => int64_val,
                _ => "".to_string(),
            }));
                },
...
match &self.uint64 {
                Some(uint64_val) => {
                    parts.push(format!("uint64={}", match serde_json::to_string(uint64_val) {
                Ok(uint64_val) => uint64_val,
                _ => "".to_string(),
            }));
                },
...
match &self.enumerator {
                Some(enumerator_val) => {
                    parts.push(format!("enumerator={}", match serde_json::to_string(enumerator_val) {
                Ok(enumerator_val) => enumerator_val,
                _ => "".to_string(),
            }));
                },
...
match &self.array {
                Some(array_val) => {
                    parts.push(format!("array={}", match serde_json::to_string(array_val) {
                Ok(array_val) => array_val,
                _ => "".to_string(),
            }));
                },
...
match &self.object {
                Some(object_val) => {
                    parts.push(format!("object={}", ObjectWithEveryOptionalTypeObject.to_query_params_string()));
                },
                _ => {},
            };
match &self.record {
                Some(record_val) => {
                    parts.push(format!("record={}", match serde_json::to_string(record_val) {
                Ok(record_val) => record_val,
                _ => "".to_string(),
            }));
                },
...
match &self.discriminator {
                Some(discriminator_val) => {
                    parts.push(format!("discriminator={}", match serde_json::to_string(discriminator_val) {
                Ok(discriminator_val) => discriminator_val,
                _ => "".to_string(),
            }));
                },
...
match &self.nested_object {
                Some(nested_object_val) => {
                    parts.push(format!("nestedObject={}", ObjectWithEveryOptionalTypeNestedObject.to_query_params_string()));
                },
                _ => {},
            };
match &self.nested_array {
                Some(nested_array_val) => {
                    parts.push(format!("nestedArray={}", match serde_json::to_string(nested_array_val) {
                Ok(nested_array_val) => nested_array_val,
                _ => "".to_string(),
            }));
                },
...
output.push_str(match &self.message_count.get("messageCount") {
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("messageCount={}", match serde_json::to_string(&self.message_count) {
...
output.push_str(match &self.count.get("count") {
...
output.push_str(format!("\"{}\"", &self.message.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("count={}", match serde_json::to_string(&self.count) {
...
impl ArriModel for StreamConnectionErrorTestParams {
    ...
    Some(serde_json::Value::String(status_message_val)) => status_message_val.to_owned(),
    _ => "".to_string(),
};
                Self {
                    status_code,
...
output.push_str(match &self.status_code.get("statusCode") {
...
output.push_str(format!("\"{}\"", &self.status_message.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("statusCode={}", match serde_json::to_string(&self.status_code) {
...
output.push_str(match &self.numbers.get("numbers") {
...
output.push_str(match &self.objects.get("objects") {
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("numbers={}", match serde_json::to_string(&self.numbers) {
                Ok(numbers_val) => numbers_val,
                _ => "".to_string(),
            }));
parts.push(format!("objects={}", match serde_json::to_string(&self.objects) {
...
output.push_str(format!("\"{}\"", &self.channel_id.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
...
output.push_str(format!("\"{}\"", &self.post_id.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
...
impl ArriModel for Post {
    ...
    _ => "".to_string(),
            ...
            let type = match val {
                Some(serde_json::Value(type_val)) => type_val,
                _ => serde_json::Value::Null,
            };
            let description = match val.get("description") {
    Some(serde_json::Value::String(description_val)) => Some(description_val.to_owned()),
    _ => None,
};
    ...
    _ => "".to_string(),
            ...
            let created_at = match val.get("createdAt") {
                Some(serde_json::Value::String(created_at_val)) => match DateTime::<FixedOffset>::parse_from_rfc3339(created_at_val.as_str()) {
            ...
            let updated_at = match val.get("updatedAt") {
                Some(serde_json::Value::String(updated_at_val)) => match DateTime::<FixedOffset>::parse_from_rfc3339(updated_at_val.as_str()) {
...
output.push_str(format!("\"{}\"", &self.title.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
output.push_str(",\"type\":");
output.push_str(match &self.type.get("type") {
                Some(type_val) => match serde_json::to_string(type_val) {
                    Ok(type_val_result) => type_val_result,
                    _ => "".to_string()
                },
                _ => "".to_string(),
            }.as_str());
output.push_str(",\"description\":");
output.push_str(match &self.description {
    Some(description_val) => description_val.replace("\n", "\\n").replace("\"", "\\\""),
    None => "null".to_string()
}.as_str());
output.push_str(",\"content\":");
output.push_str(format!("\"{}\"", &self.content.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
output.push_str(",\"tags\":");
output.push_str(match &self.tags.get("tags") {
...
output.push_str(format!("\"{}\"", &self.author_id.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
...
parts.push(format!("type={}", match serde_json::to_string(&self.type) {
                Ok(type_val) => type_val,
                _ => "".to_string(),
            }));
parts.push(format!("description={}", match &self.description {
                    Some(description_val) => description_val,
                    _ => "null".to_string(),
                }));
parts.push(format!("content={}", &self.content));
parts.push(format!("tags={}", match serde_json::to_string(&self.tags) {
...
pub struct PostListParams {
    pub limit: i8,
    pub type: Option<serde_json::Value>,
}
...
impl ArriModel for PostListParams {
    ...
    fn from_json(input: serde_json::Value) -> Self {
        match input {
            serde_json::Value::Object(val) => {
            let limit = match val {
                Some(serde_json::Value::number(limit_val)) => limit _val.as_i64().try_into:: <i8>().unwrap_or(0),
                _ => 0
            };
let type = match val.get("type") {
                 Some(serde_json::Value(type_val)) => match type_val {
                Some(serde_json::Value(type_val)) => Some(type_val),
                _ => None,
            },
                 _ => None,
            };
...
match &self.type {
                    Some(type_val) => {
                        output.push_str(",\"type\":");
                        output.push_str(match type_val.get("type") {
                Some(type_val) => match serde_json::to_string(type_val) {
                    Ok(type_val_result) => type_val_result,
                    _ => "".to_string()
                },
...
match &self.type {
                Some(type_val) => {
                    parts.push(format!("type={}", match serde_json::to_string(type_val) {
                Ok(type_val) => type_val,
                _ => "".to_string(),
            }));
                },
...
output.push_str(match &self.total.get("total") {
...
output.push_str(match &self.items.get("items") {
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("total={}", match serde_json::to_string(&self.total) {
                Ok(total_val) => total_val,
                _ => "".to_string(),
            }));
parts.push(format!("items={}", match serde_json::to_string(&self.items) {
...
output.push_str(data.to_json_string().as_str());
    ...
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("postId={}", &self.post_id));
parts.push(format!("data={}", UpdatePostParamsData.to_query_params_string()));
        parts.join("&")
    }
}
...
output.push_str(format!("\"{}\"", &self.version.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
    ...
    fn from_json(input: serde_json::Value) -> Self {
        match input {
            ...
            let annotation_id = match val {
                Some(serde_json::Value(annotationId_val)) => AnnotationId.from_json(annotationId_val),
                _ => AnnotationId::new(),
            };
            let associated_id = match val {
                Some(serde_json::Value(associatedId_val)) => AssociatedId.from_json(associatedId_val),
                _ => AssociatedId::new(),
            };
            ...
            let annotation_type_version = match val {
                Some(serde_json::Value(annotation_type_version_val)) => annotation_type_version_val,
                _ => serde_json::Value::Null,
            };
            ...
            let box_type_range = match val {
                Some(serde_json::Value(boxTypeRange_val)) => AnnotationBoxTypeRange.from_json(boxTypeRange_val),
...
output.push_str(annotationId.to_json_string().as_str());
output.push_str(",\"associated_id\":");
output.push_str(associatedId.to_json_string().as_str());
output.push_str(",\"annotation_type\":");
output.push_str(match &self.annotation_type.get("annotation_type") {
...
output.push_str(match &self.annotation_type_version.get("annotation_type_version") {
                Some(annotation_type_version_val) => match serde_json::to_string(annotation_type_version_val) {
                    Ok(annotation_type_version_val_result) => annotation_type_version_val_result,
                    _ => "".to_string()
                },
                _ => "".to_string(),
            }.as_str());
output.push_str(",\"metadata\":");
output.push_str(match &self.metadata.get("metadata") {
...
output.push_str(boxTypeRange.to_json_string().as_str());
        output.push('}');
        output
    }
    fn to_query_params_string(&self) -> String {
        let mut parts: Vec<String> = Vec::new();
        parts.push(format!("annotation_id={}", AnnotationId.to_query_params_string()));
parts.push(format!("associated_id={}", AssociatedId.to_query_params_string()));
parts.push(format!("annotation_type={}", match serde_json::to_string(&self.annotation_type) {
                Ok(annotation_type_val) => annotation_type_val,
                _ => "".to_string(),
            }));
parts.push(format!("annotation_type_version={}", match serde_json::to_string(&self.annotation_type_version) {
                Ok(annotation_type_version_val) => annotation_type_version_val,
                _ => "".to_string(),
            }));
parts.push(format!("metadata={}", match serde_json::to_string(&self.metadata) {
                Ok(metadata_val) => metadata_val,
                _ => "".to_string(),
            }));
parts.push(format!("box_type_range={}", AnnotationBoxTypeRange.to_query_params_string()));
        parts.join("&")
    }
}
...
impl ArriModel for UpdateAnnotationParams {
    ...
    Some(serde_json::Value::String(annotation_id_val)) => annotation_id_val.to_owned(),
    _ => "".to_string(),
};
            let annotation_id_version = match val.get("annotation_id_version") {
    Some(serde_json::Value::String(annotation_id_version_val)) => annotation_id_version_val.to_owned(),
    _ => "".to_string(),
};
            let data = match val {
    ...
    fn to_json_string(&self) -> String {
        let mut output = "{".to_string();
        output.push_str("\"annotation_id\":");
output.push_str(format!("\"{}\"", &self.annotation_id.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
output.push_str(",\"annotation_id_version\":");
output.push_str(format!("\"{}\"", &self.annotation_id_version.replace("\n", "\\n").replace("\"", "\\\"")).as_str());
output.push_str(",\"data\":");
output.push_str(data.to_json_string().as_str());
        output.push('}');
        output
...
parts.push(format!("annotation_id_version={}", &self.annotation_id_version));
parts.push(format!("data={}", UpdateAnnotationData.to_query_params_string()));
        parts.join("&")
    }
}