...
class TestClient(
    ...
    val adapters: TestClientAdaptersService = TestClientAdaptersService(
                httpClient = httpClient,
                baseUrl = baseUrl,
                headers = headers,
            )
...
data class TypeBoxObject(
    ...
    val `object`: TypeBoxObjectObject,
...
if (optionalString != null) {
                ...
                output += buildString { printQuoted(optionalString) }
            }
output += "}"
return output    
    }
...
queryParts.add("integer=$integer")
queryParts.add("number=$number")
queryParts.add("enumField=${enumField.serialValue}")
__logError("[WARNING] nested objects cannot be serialized to query params. Skipping field at /TypeBoxObject/object.")
__logError("[WARNING] arrays cannot be serialized to query params. Skipping field at /TypeBoxObject/array.")
if (optionalString != null) {
            queryParts.add("optionalString=$optionalString")
        }
return queryParts.joinToString("&")
    }

    companion object Factory : TestClientModelFactory<TypeBoxObject> {
        @JvmStatic
        override fun new(): TypeBoxObject {
        ...
        @JvmStatic
        override fun fromJson(input: String): TypeBoxObject {
            return fromJsonElement(JsonInstance.parseToJsonElement(input))
        }

        @JvmStatic
        override fun fromJsonElement(__input: JsonElement, instancePath: String): TypeBoxObject {
            if (__input !is JsonObject) {
                __logError("[WARNING] TypeBoxObject.fromJsonElement() expected kotlinx.serialization.json.JsonObject at $instancePath. Got ${__input.javaClass}. Initializing empty TypeBoxObject.")
                return new()
            }
...
val integer: Int = when (__input.jsonObject["integer"]) {
                is JsonPrimitive -> __input.jsonObject["integer"]!!.jsonPrimitive.intOrNull ?: 0
                else -> 0
            }
val number: Double = when (__input.jsonObject["number"]) {
                is JsonPrimitive -> __input.jsonObject["number"]!!.jsonPrimitive.doubleOrNull ?: 0.0
                else -> 0.0
            }
val enumField: TypeBoxObjectEnumField = when (__input.jsonObject["enumField"]) {
                is JsonNull -> TypeBoxObjectEnumField.new()
                is JsonPrimitive -> TypeBoxObjectEnumField.fromJsonElement(__input.jsonObject["enumField"]!!, "$instancePath/enumField")
                else -> TypeBoxObjectEnumField.new()
            }
val `object`: TypeBoxObjectObject = when (__input.jsonObject["object"]) {
                is JsonObject -> TypeBoxObjectObject.fromJsonElement(
                    __input.jsonObject["object"]!!,
                    "$instancePath/object",
                )

                else -> TypeBoxObjectObject.new()
            }
...
val optionalString: String? = when (__input.jsonObject["optionalString"]) {
                    is JsonPrimitive -> __input.jsonObject["optionalString"]!!.jsonPrimitive.contentOrNull
                    else -> null
                }
            return TypeBoxObject(
                string,
...
enum class TypeBoxObjectEnumField {
    ...
    companion object Factory : TestClientModelFactory<TypeBoxObjectEnumField> {
        @JvmStatic
        override fun new(): TypeBoxObjectEnumField {
            return A
        }

        @JvmStatic
        override fun fromJson(input: String): TypeBoxObjectEnumField {
            return when (input) {
                A.serialValue -> A
                B.serialValue -> B
                C.serialValue -> C
        ...
        @JvmStatic
        override fun fromJsonElement(__input: JsonElement, instancePath: String): TypeBoxObjectEnumField {
            if (__input !is JsonPrimitive) {
                __logError("[WARNING] TypeBoxObjectEnumField.fromJsonElement() expected kotlinx.serialization.json.JsonPrimitive at $instancePath. Got ${__input.javaClass}. Initializing empty TypeBoxObjectEnumField.")
                return new()
            }
...
return queryParts.joinToString("&")
    ...
    companion object Factory : TestClientModelFactory<TypeBoxObjectObject> {
        @JvmStatic
        override fun new(): TypeBoxObjectObject {
        ...
        @JvmStatic
        override fun fromJson(input: String): TypeBoxObjectObject {
            return fromJsonElement(JsonInstance.parseToJsonElement(input))
        }

        @JvmStatic
        override fun fromJsonElement(__input: JsonElement, instancePath: String): TypeBoxObjectObject {
            if (__input !is JsonObject) {
                __logError("[WARNING] TypeBoxObjectObject.fromJsonElement() expected kotlinx.serialization.json.JsonObject at $instancePath. Got ${__input.javaClass}. Initializing empty TypeBoxObjectObject.")
                return new()
            }
val string: String = when (__input.jsonObject["string"]) {
                is JsonPrimitive -> __input.jsonObject["string"]!!.jsonPrimitive.contentOrNull ?: ""
