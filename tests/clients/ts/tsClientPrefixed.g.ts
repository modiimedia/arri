...
export class TestClientPrefixedTestsService {
  ...
  async emptyResponseGetRequest(params: FooDefaultPayload): Promise<undefined> {
  ...
  async sendObjectWithSnakeCaseKeys(
    ...
    return arriRequest<FooObjectWithSnakeCaseKeys, FooObjectWithSnakeCaseKeys>({
    ...
    >(
      {
        ...
        onError: this._onError,
        params: params,
        responseFromJson: $$FooStreamConnectionErrorTestResponse.fromJson,
        responseFromString:
          $$FooStreamConnectionErrorTestResponse.fromJsonString,
        serializer: $$FooStreamConnectionErrorTestParams.toUrlQueryString,
        clientVersion: "10",
      },
      options,
    );
    ...
    return arriSseRequest<FooStreamLargeObjectsResponse, undefined>(
      {
        ...
        responseFromString: $$FooStreamLargeObjectsResponse.fromJsonString,
        serializer: () => {},
        clientVersion: "10",
      },
      options,
...
export class TestClientPrefixedUsersService {
  ...
  watchUser(
    ...
    return arriSseRequest<FooUsersWatchUserResponse, FooUsersWatchUserParams>(
      {
...
export const $$FooObjectWithEveryType: ArriModelValidator<FooObjectWithEveryType> =
  {
    ...
    validate(input): input is FooObjectWithEveryType {
      return (
        ...
        $$FooObjectWithEveryTypeDiscriminator.validate(input.discriminator) &&
        $$FooObjectWithEveryTypeNestedObject.validate(input.nestedObject) &&
    ...
    fromJson(input): FooObjectWithEveryType {
      ...
      if (typeof input.enumerator === "string") {
        _enumerator = $$FooObjectWithEveryTypeEnumerator.fromSerialValue(
          input.enumerator,
        );
      } else {
...
export const $$FooObjectWithEveryTypeDiscriminator: ArriModelValidator<FooObjectWithEveryTypeDiscriminator> =
  {
    ...
    validate(input): input is FooObjectWithEveryTypeDiscriminator {
      ...
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryTypeDiscriminatorA.validate(input);
        case "B":
          return $$FooObjectWithEveryTypeDiscriminatorB.validate(input);
        default:
          return false;
      }
    },
    fromJson(input): FooObjectWithEveryTypeDiscriminator {
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryTypeDiscriminatorA.fromJson(input);
        case "B":
          return $$FooObjectWithEveryTypeDiscriminatorB.fromJson(input);
        default:
          return $$FooObjectWithEveryTypeDiscriminatorA.new();
      }
    },
    fromJsonString(input): FooObjectWithEveryTypeDiscriminator {
      return $$FooObjectWithEveryTypeDiscriminator.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryTypeDiscriminatorA.toJsonString(input);
        case "B":
          return $$FooObjectWithEveryTypeDiscriminatorB.toJsonString(input);
        default:
    ...
    toUrlQueryString(input): string {
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryTypeDiscriminatorA.toUrlQueryString(input);
        case "B":
          return $$FooObjectWithEveryTypeDiscriminatorB.toUrlQueryString(input);
        default:
...
const $$FooObjectWithEveryTypeDiscriminatorA: ArriModelValidator<FooObjectWithEveryTypeDiscriminatorA> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryTypeDiscriminatorA {
      return $$FooObjectWithEveryTypeDiscriminatorA.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"type":"A"';
...
const $$FooObjectWithEveryTypeDiscriminatorB: ArriModelValidator<FooObjectWithEveryTypeDiscriminatorB> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryTypeDiscriminatorB {
      return $$FooObjectWithEveryTypeDiscriminatorB.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"type":"B"';
...
export const $$FooObjectWithEveryTypeNestedObject: ArriModelValidator<FooObjectWithEveryTypeNestedObject> =
  {
    ...
    fromJson(input): FooObjectWithEveryTypeNestedObject {
      ...
      if (isObject(input.data)) {
        _data = $$FooObjectWithEveryTypeNestedObjectData.fromJson(input.data);
      } else {
    ...
    fromJsonString(input): FooObjectWithEveryTypeNestedObject {
      return $$FooObjectWithEveryTypeNestedObject.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"id":';
      ...
      json += `"${input.timestamp.toISOString()}"`;
      json += ',"data":';
      json += $$FooObjectWithEveryTypeNestedObjectData.toJsonString(input.data);
      json += "}";
      return json;
    },
    toUrlQueryString(input): string {
...
export const $$FooObjectWithEveryTypeNestedObjectData: ArriModelValidator<FooObjectWithEveryTypeNestedObjectData> =
  {
    ...
    validate(input): input is FooObjectWithEveryTypeNestedObjectData {
      return (
        ...
        typeof input.id === "string" &&
        input.timestamp instanceof Date &&
        $$FooObjectWithEveryTypeNestedObjectDataData.validate(input.data)
      );
    },
...
export const $$FooObjectWithEveryTypeNestedArrayElementElement: ArriModelValidator<FooObjectWithEveryTypeNestedArrayElementElement> =
  {
    ...
    validate(input): input is FooObjectWithEveryTypeNestedArrayElementElement {
      return (
        isObject(input) &&
        typeof input.id === "string" &&
        input.timestamp instanceof Date
...
export const $$FooObjectWithEveryNullableType: ArriModelValidator<FooObjectWithEveryNullableType> =
  {
    ...
    validate(input): input is FooObjectWithEveryNullableType {
      return (
        ...
        ((Array.isArray(input.array) &&
          input.array.every(
            (_element) => typeof _element === "boolean" || _element === null,
          )) ||
          input.array === null) &&
        ($$FooObjectWithEveryNullableTypeObject.validate(input.object) ||
          input.object === null) &&
        ((isObject(input.record) &&
          Object.values(input.record).every(
            (_value) =>
    ...
    fromJson(input): FooObjectWithEveryNullableType {
      ...
      if (isObject(input.object)) {
        _object = $$FooObjectWithEveryNullableTypeObject.fromJson(input.object);
      } else {
        _object = null;
      }
      ...
      if (isObject(input.discriminator)) {
        _discriminator = $$FooObjectWithEveryNullableTypeDiscriminator.fromJson(
          input.discriminator,
        );
      } else {
        _discriminator = null;
      ...
      if (isObject(input.nestedObject)) {
        _nestedObject = $$FooObjectWithEveryNullableTypeNestedObject.fromJson(
          input.nestedObject,
        );
      } else {
        _nestedObject = null;
    ...
    toJsonString(input): string {
      ...
      if (input.discriminator != null) {
        json += $$FooObjectWithEveryNullableTypeDiscriminator.toJsonString(
          input.discriminator,
        );
      } else {
        json += "null";
      ...
      if (input.nestedObject !== null) {
        json += $$FooObjectWithEveryNullableTypeNestedObject.toJsonString(
          input.nestedObject,
        );
      } else {
        json += "null";
...
export const $$FooObjectWithEveryNullableTypeObject: ArriModelValidator<FooObjectWithEveryNullableTypeObject> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryNullableTypeObject {
      return $$FooObjectWithEveryNullableTypeObject.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"string":';
...
export const $$FooObjectWithEveryNullableTypeDiscriminator: ArriModelValidator<FooObjectWithEveryNullableTypeDiscriminator> =
  {
    ...
    validate(input): input is FooObjectWithEveryNullableTypeDiscriminator {
      ...
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryNullableTypeDiscriminatorA.validate(input);
        case "B":
          return $$FooObjectWithEveryNullableTypeDiscriminatorB.validate(input);
        default:
          return false;
      }
    },
    fromJson(input): FooObjectWithEveryNullableTypeDiscriminator {
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryNullableTypeDiscriminatorA.fromJson(input);
        case "B":
          return $$FooObjectWithEveryNullableTypeDiscriminatorB.fromJson(input);
        default:
          return $$FooObjectWithEveryNullableTypeDiscriminatorA.new();
      }
    },
...
export const $$FooObjectWithEveryNullableTypeNestedObject: ArriModelValidator<FooObjectWithEveryNullableTypeNestedObject> =
  {
    ...
    fromJson(input): FooObjectWithEveryNullableTypeNestedObject {
      ...
      if (isObject(input.data)) {
        _data = $$FooObjectWithEveryNullableTypeNestedObjectData.fromJson(
          input.data,
        );
      } else {
        _data = null;
    ...
    toJsonString(input): string {
      ...
      json += ',"data":';
      if (input.data !== null) {
        json += $$FooObjectWithEveryNullableTypeNestedObjectData.toJsonString(
          input.data,
        );
      } else {
        json += "null";
...
export const $$FooObjectWithEveryNullableTypeNestedObjectData: ArriModelValidator<FooObjectWithEveryNullableTypeNestedObjectData> =
  {
    ...
    validate(input): input is FooObjectWithEveryNullableTypeNestedObjectData {
      return (
        isObject(input) &&
        (typeof input.id === "string" || input.id === null) &&
        (input.timestamp instanceof Date || input.timestamp === null) &&
    ...
    fromJson(input): FooObjectWithEveryNullableTypeNestedObjectData {
      ...
      if (isObject(input.data)) {
        _data = $$FooObjectWithEveryNullableTypeNestedObjectDataData.fromJson(
          input.data,
        );
      } else {
        _data = null;
...
export const $$FooObjectWithEveryNullableTypeNestedObjectDataData: ArriModelValidator<FooObjectWithEveryNullableTypeNestedObjectDataData> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryNullableTypeNestedObjectDataData {
...
export const $$FooObjectWithEveryNullableTypeNestedArrayElementElement: ArriModelValidator<FooObjectWithEveryNullableTypeNestedArrayElementElement> =
  {
    ...
    fromJson(input): FooObjectWithEveryNullableTypeNestedArrayElementElement {
      let _id: string | null;
      if (typeof input.id === "string") {
        _id = input.id;
      } else {
...
export const $$FooObjectWithEveryOptionalType: ArriModelValidator<FooObjectWithEveryOptionalType> =
  {
    ...
    validate(input): input is FooObjectWithEveryOptionalType {
      return (
        ...
        ($$FooObjectWithEveryOptionalTypeObject.validate(input.object) ||
    ...
    fromJson(input): FooObjectWithEveryOptionalType {
      ...
      if (typeof input.enumerator !== "undefined") {
        if (typeof input.enumerator === "string") {
          ...
          _enumerator = $$FooObjectWithEveryOptionalTypeEnumerator.new();
        }
      }
      ...
      if (typeof input.discriminator !== "undefined") {
        if (isObject(input.discriminator)) {
          ...
          _discriminator = $$FooObjectWithEveryOptionalTypeDiscriminator.new();
        }
      }
      let _nestedObject: FooObjectWithEveryOptionalTypeNestedObject | undefined;
      if (typeof input.nestedObject !== "undefined") {
        if (isObject(input.nestedObject)) {
          _nestedObject = $$FooObjectWithEveryOptionalTypeNestedObject.fromJson(
            input.nestedObject,
          );
        } else {
          _nestedObject = $$FooObjectWithEveryOptionalTypeNestedObject.new();
        }
      }
      let _nestedArray:
    ...
    toJsonString(input): string {
      ...
      if (typeof input.discriminator !== "undefined") {
        if (_hasKey) json += ",";
        json += '"discriminator":';
        json += $$FooObjectWithEveryOptionalTypeDiscriminator.toJsonString(
          input.discriminator,
        );
        _hasKey = true;
      }
      if (typeof input.nestedObject !== "undefined") {
        if (_hasKey) json += ",";
        json += '"nestedObject":';
        json += $$FooObjectWithEveryOptionalTypeNestedObject.toJsonString(
          input.nestedObject,
        );
        _hasKey = true;
      }
...
export const $$FooObjectWithEveryOptionalTypeObject: ArriModelValidator<FooObjectWithEveryOptionalTypeObject> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryOptionalTypeObject {
      return $$FooObjectWithEveryOptionalTypeObject.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"string":';
...
export const $$FooObjectWithEveryOptionalTypeDiscriminator: ArriModelValidator<FooObjectWithEveryOptionalTypeDiscriminator> =
  {
    ...
    validate(input): input is FooObjectWithEveryOptionalTypeDiscriminator {
      ...
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryOptionalTypeDiscriminatorA.validate(input);
        case "B":
          return $$FooObjectWithEveryOptionalTypeDiscriminatorB.validate(input);
        default:
          return false;
      }
    },
    fromJson(input): FooObjectWithEveryOptionalTypeDiscriminator {
      switch (input.type) {
        case "A":
          return $$FooObjectWithEveryOptionalTypeDiscriminatorA.fromJson(input);
        case "B":
          return $$FooObjectWithEveryOptionalTypeDiscriminatorB.fromJson(input);
        default:
          return $$FooObjectWithEveryOptionalTypeDiscriminatorA.new();
      }
    },
...
export const $$FooObjectWithEveryOptionalTypeNestedObject: ArriModelValidator<FooObjectWithEveryOptionalTypeNestedObject> =
  {
    ...
    validate(input): input is FooObjectWithEveryOptionalTypeNestedObject {
      return (
        ...
        typeof input.id === "string" &&
        input.timestamp instanceof Date &&
        $$FooObjectWithEveryOptionalTypeNestedObjectData.validate(input.data)
      );
    },
    fromJson(input): FooObjectWithEveryOptionalTypeNestedObject {
      ...
      if (isObject(input.data)) {
        _data = $$FooObjectWithEveryOptionalTypeNestedObjectData.fromJson(
          input.data,
        );
      } else {
    ...
    toJsonString(input): string {
      ...
      json += `"${input.timestamp.toISOString()}"`;
      json += ',"data":';
      json += $$FooObjectWithEveryOptionalTypeNestedObjectData.toJsonString(
        input.data,
      );
      json += "}";
      return json;
...
export const $$FooObjectWithEveryOptionalTypeNestedObjectData: ArriModelValidator<FooObjectWithEveryOptionalTypeNestedObjectData> =
  {
    ...
    validate(input): input is FooObjectWithEveryOptionalTypeNestedObjectData {
      return (
        isObject(input) &&
        typeof input.id === "string" &&
        input.timestamp instanceof Date &&
    ...
    fromJson(input): FooObjectWithEveryOptionalTypeNestedObjectData {
      ...
      if (isObject(input.data)) {
        _data = $$FooObjectWithEveryOptionalTypeNestedObjectDataData.fromJson(
          input.data,
        );
      } else {
        _data = $$FooObjectWithEveryOptionalTypeNestedObjectDataData.new();
      }
      return {
        id: _id,
        timestamp: _timestamp,
    ...
    toJsonString(input): string {
      ...
      json += `"${input.timestamp.toISOString()}"`;
      json += ',"data":';
      json += $$FooObjectWithEveryOptionalTypeNestedObjectDataData.toJsonString(
        input.data,
      );
      json += "}";
      return json;
...
export const $$FooObjectWithEveryOptionalTypeNestedObjectDataData: ArriModelValidator<FooObjectWithEveryOptionalTypeNestedObjectDataData> =
  {
    ...
    fromJsonString(input): FooObjectWithEveryOptionalTypeNestedObjectDataData {
...
export const $$FooObjectWithEveryOptionalTypeNestedArrayElementElement: ArriModelValidator<FooObjectWithEveryOptionalTypeNestedArrayElementElement> =
  {
    ...
    fromJson(input): FooObjectWithEveryOptionalTypeNestedArrayElementElement {
      let _id: string;
      if (typeof input.id === "string") {
        _id = input.id;
      } else {
...
export const $$FooRecursiveObject: ArriModelValidator<FooRecursiveObject> = {
  ...
  validate(input): input is FooRecursiveObject {
    return (
      isObject(input) &&
      ($$FooRecursiveObject.validate(input.left) || input.left === null) &&
      ($$FooRecursiveObject.validate(input.right) || input.right === null) &&
...
const $$FooRecursiveUnionChildren: ArriModelValidator<FooRecursiveUnionChildren> =
  {
    ...
    validate(input): input is FooRecursiveUnionChildren {
      return (
        ...
        input.data.every((_element) => $$FooRecursiveUnion.validate(_element))
      );
    },
...
const $$FooRecursiveUnionText: ArriModelValidator<FooRecursiveUnionText> = {
  ...
  validate(input): input is FooRecursiveUnionText {
    return (
      isObject(input) && input.type === "TEXT" && typeof input.data === "string"
    );
  },
...
export const $$FooStreamConnectionErrorTestParams: ArriModelValidator<FooStreamConnectionErrorTestParams> =
  {
    ...
    fromJsonString(input): FooStreamConnectionErrorTestParams {
      return $$FooStreamConnectionErrorTestParams.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"statusCode":';
...
export const $$FooStreamConnectionErrorTestResponse: ArriModelValidator<FooStreamConnectionErrorTestResponse> =
  {
    ...
    fromJsonString(input): FooStreamConnectionErrorTestResponse {
      return $$FooStreamConnectionErrorTestResponse.fromJson(JSON.parse(input));
    },
    toJsonString(input): string {
      let json = "{";
      json += '"message":';
    ...
    validate(input): input is FooStreamLargeObjectsResponse {
      return (
        ...
        input.objects.every((_element) =>
          $$FooStreamLargeObjectsResponseObjectsElement.validate(_element),
        )
      );
    },
...
export const $$FooTestsStreamRetryWithNewCredentialsResponse: ArriModelValidator<FooTestsStreamRetryWithNewCredentialsResponse> =
  {
    ...
    validate(input): input is FooTestsStreamRetryWithNewCredentialsResponse {
      return isObject(input) && typeof input.message === "string";
    },
...
export const $$FooUsersWatchUserResponse: ArriModelValidator<FooUsersWatchUserResponse> =
  {
    ...
    validate(input): input is FooUsersWatchUserResponse {
      return (
        ...
        ($$FooUserPhoto.validate(input.photo) || input.photo === null) &&
        input.createdAt instanceof Date &&
    ...
    fromJson(input): FooUsersWatchUserResponse {
      ...
      if (typeof input.role === "string") {
        _role = $$FooUsersWatchUserResponseRole.fromSerialValue(input.role);
      } else {
      ...
      if (isObject(input.bookmarks)) {
        ...
        for (const [_key, _value] of Object.entries(input.bookmarks)) {
          ...
          if (isObject(_value)) {
            _bookmarksValue =
              $$FooUsersWatchUserResponseBookmarksValue.fromJson(_value);
          } else {
            _bookmarksValue = $$FooUsersWatchUserResponseBookmarksValue.new();
          }
    ...
    toJsonString(input): string {
      ...
      for (const [_key, _value] of Object.entries(input.bookmarks)) {
        ...
        json += `${serializeString(_key)}:`;
        json += $$FooUsersWatchUserResponseBookmarksValue.toJsonString(_value);
...
export const $$FooUsersWatchUserResponseRecentNotificationsElement: ArriModelValidator<FooUsersWatchUserResponseRecentNotificationsElement> =
  {
    ...
    fromJsonString(input): FooUsersWatchUserResponseRecentNotificationsElement {
