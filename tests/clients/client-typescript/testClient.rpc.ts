...
import { arriRequest, arriSseRequest, type SseHooks } from "arri-client";
...
export class TestClientMiscTestsService {
  ...
  sendObjectStream(
    ...
    hooks: SseHooks<MiscTestsSendObjectStreamResponse>,
  ) {
    return arriSseRequest<
      MiscTestsSendObjectStreamResponse,
      MiscTestsSendObjectStreamParams
    >(
      {
        ...
        headers: this.headers,
        params,
        parser: $$MiscTestsSendObjectStreamResponse.parse,
  ...
  sendStreamWithErrors(hooks: SseHooks<MiscTestsSendStreamWithErrorsResponse>) {
...
export type MiscTestsSendObjectStreamResponse =
  | MiscTestsSendObjectStreamResponseText
  | MiscTestsSendObjectStreamResponseImage
  | MiscTestsSendObjectStreamResponseUrl;
const $$MiscTestsSendObjectStreamResponse = {
  parse(input: Record<any, any>): MiscTestsSendObjectStreamResponse {
    class $ValidationErrorDfb36a8798fb433f8c07F2e9b68e8d1e extends Error {
      errors;
      constructor(input) {
        super(input.message);
        this.errors = input.errors;
    ...
    function $fallback(instancePath, schemaPath, message) {
      throw new $ValidationErrorDfb36a8798fb433f8c07F2e9b68e8d1e({
        message: message,
        errors: [
          {
            instancePath: instancePath,
      ...
      switch (input.messageType) {
        case "TEXT": {
          if (typeof input === "object" && input !== null) {
            ...
            if (typeof input.date === "object" && input.date instanceof Date) {
  ...
  serialize(input: MiscTestsSendObjectStreamResponse): string {
    let json = "";
    switch (input.messageType) {
      case "TEXT": {
        json += "{";
...
export interface MiscTestsSendObjectStreamResponseText {
  messageType: "TEXT";
  id: string;
  channelId: string;
  userId: string;
...
export interface MiscTestsSendObjectStreamResponseImage {
  messageType: "IMAGE";
  id: string;
  channelId: string;
  userId: string;
...
export interface MiscTestsSendObjectStreamResponseUrl {
  messageType: "URL";
  id: string;
  channelId: string;
  userId: string;
