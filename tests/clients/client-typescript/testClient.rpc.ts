...
export class TestClientMiscTestsService {
  ...
  sendObjectStream(params: MiscTestsSendObjectStreamParams) {
    return arriRequest<
...
const $$MiscTestsSendObjectStreamResponse = {
  parse(input: Record<any, any>): MiscTestsSendObjectStreamResponse {
    class $ValidationErrorB1171a5577474f3dA7131847f35edac7 extends Error {
      errors;
      constructor(input) {
        super(input.message);
        this.errors = input.errors;
    ...
    function $fallback(instancePath, schemaPath, message) {
      throw new $ValidationErrorB1171a5577474f3dA7131847f35edac7({
        message: message,
        errors: [
          {
            instancePath: instancePath,
