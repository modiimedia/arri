...
__queryParts.append("hello=\(self.hello)")
...
__json += serializeString(input: self.deprecatedField)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("deprecatedField=\(self.deprecatedField)")
        return __queryParts.joined(separator: "&")
    }
...
__queryParts.append("enumerator=\(self.enumerator.serialValue())")
...
__queryParts.append("title=\(self.title)")
        return __queryParts.joined(separator: "&")
    }
...
__queryParts.append("title=\(self.title)")
__queryParts.append("description=\(self.description)")
        return __queryParts.joined(separator: "&")
    }
...
if self.enumerator != nil {
                    ...
                    __queryParts.append("enumerator=null") 
                }
...
if self.title != nil {
                    ...
                    __queryParts.append("title=null") 
                }
        return __queryParts.joined(separator: "&")
    }
...
if self.description != nil {
                    ...
                    __queryParts.append("description=null") 
                }
        return __queryParts.joined(separator: "&")
    }
...
__queryParts.append("value=\(self.value)")
        return __queryParts.joined(separator: "&")
    }
...
__json += self.data.toJSONString()
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=CHILD")
...
__json += "["
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=CHILDREN")
...
__json += serializeString(input: self.data)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=TEXT")
__queryParts.append("data=\(self.data)")
        return __queryParts.joined(separator: "&")
    }
...
__json += self.data.toJSONString()
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=SHAPE")
...
__json += serializeString(input: self.color)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("width=\(self.width)")
__queryParts.append("height=\(self.height)")
__queryParts.append("color=\(self.color)")
        return __queryParts.joined(separator: "&")
    }
...
__json += "\(self.messageCount)"
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("messageCount=\(self.messageCount)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.message)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("count=\(self.count)")
__queryParts.append("message=\(self.message)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.statusMessage)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("statusCode=\(self.statusCode)")
__queryParts.append("statusMessage=\(self.statusMessage)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.channelId)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("channelId=\(self.channelId)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.image)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("messageType=IMAGE")
__queryParts.append("id=\(self.id)")
__queryParts.append("channelId=\(self.channelId)")
__queryParts.append("userId=\(self.userId)")
__queryParts.append("date=\(serializeDate(self.date, withQuotes: false))")
__queryParts.append("image=\(self.image)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.url)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("messageType=URL")
__queryParts.append("id=\(self.id)")
__queryParts.append("channelId=\(self.channelId)")
__queryParts.append("userId=\(self.userId)")
__queryParts.append("date=\(serializeDate(self.date, withQuotes: false))")
__queryParts.append("url=\(self.url)")
        return __queryParts.joined(separator: "&")
    }
...
__json += "\(self.y)"
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=CREATE_ENTITY")
__queryParts.append("entityId=\(self.entityId)")
__queryParts.append("x=\(self.x)")
__queryParts.append("y=\(self.y)")
        return __queryParts.joined(separator: "&")
    }
...
__json += "\(self.y)"
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=UPDATE_ENTITY")
__queryParts.append("entityId=\(self.entityId)")
__queryParts.append("x=\(self.x)")
__queryParts.append("y=\(self.y)")
        return __queryParts.joined(separator: "&")
...
__json += serializeString(input: self.reason)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=DISCONNECT")
__queryParts.append("reason=\(self.reason)")
        return __queryParts.joined(separator: "&")
    }
...
__json += "\(self.y)"
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=ENTITY_CREATED")
__queryParts.append("entityId=\(self.entityId)")
__queryParts.append("x=\(self.x)")
__queryParts.append("y=\(self.y)")
        return __queryParts.joined(separator: "&")
...
__json += "\(self.y)"
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("type=ENTITY_UPDATED")
__queryParts.append("entityId=\(self.entityId)")
__queryParts.append("x=\(self.x)")
__queryParts.append("y=\(self.y)")
        return __queryParts.joined(separator: "&")
...
__json += serializeString(input: self.bio!)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("id=\(self.id)")
__queryParts.append("role=\(self.role.serialValue())")
...
__queryParts.append("numFollowers=\(self.numFollowers)")
...
if self.bio != nil {
                    __queryParts.append("bio=\(self.bio!)")
                }
        return __queryParts.joined(separator: "&")
    }
...
__queryParts.append("width=\(self.width)")
__queryParts.append("height=\(self.height)")
__queryParts.append("bytes=\(self.bytes)")
__queryParts.append("nanoseconds=\(self.nanoseconds)")
        return __queryParts.joined(separator: "&")
    }
...
__json += "\"\(self.preferredTheme.serialValue())\""
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
__queryParts.append("notificationsEnabled=\(self.notificationsEnabled)")
__queryParts.append("preferredTheme=\(self.preferredTheme.serialValue())")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.userId)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("notificationType=POST_LIKE")
__queryParts.append("postId=\(self.postId)")
__queryParts.append("userId=\(self.userId)")
        return __queryParts.joined(separator: "&")
    }
...
__json += serializeString(input: self.commentText)
    ...
    public func toQueryString() -> String {
        var __queryParts: [String] = []
       __queryParts.append("notificationType=POST_COMMENT")
__queryParts.append("postId=\(self.postId)")
__queryParts.append("userId=\(self.userId)")
